...
//   tableColumn: PropTypes.any,
// };
// export default function VendorsList({ tableRows, tableColumn }) {
//   const theme = useTheme();
//   const tableName = 'Vendors List';
//   const { themeStretch } = useSettings();
...
//                 variant="contained"
//                 component={RouterLink}
//                 to={PATH_DASHBOARD.user.addvendor}
...
//                           <UserMoreMenu onDelete={() => handleDeleteUser(id)} userName={name} editUrl={'/editvendor'} />
//                         </TableCell>
//                       </TableRow>
//                     );
//                   })}
